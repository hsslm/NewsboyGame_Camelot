...
public class Journal extends ObjetDuJeu {
    ...
    public void update(double deltaTemps,ArrayList<Particule> particules) {
        //Recalcule l'accélération totale incluant les particules
        calculeraccelerationTotale(particules);
